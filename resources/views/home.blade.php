    ...
    <section class="relative text-white py-20 lg:py-32 overflow-hidden bg-cover bg-center"
        ...
        <div class="container mx-auto px-4 relative z-10 text-center">
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-white">
                ...
                <span class="text-brand-yellow">Segala Jenis Event</span>
            </h1>
                        ...
                        <a href="{{ route('events.show', $event->slug) }}">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-xs text-gray-500 mb-3">
                                    <i class="fas fa-map-marker-alt mr-1"></i>{{ $event->venue->name ?? 'Venue Belum Ditentukan' }}
                                </p>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <!-- Stand Up -->
                <a href="{{ route('events.index', ['category' => 'standup-comedy']) }}"
                    class="group bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition text-center border border-gray-100">
                    <div
    ...
    <section class="py-20 bg-slate-900 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
                Temukan event favoritmu dan buat kenangan tak terlupakan bersama Tiketin!
            </p>
            <a href="{{ route('events.index') }}"
